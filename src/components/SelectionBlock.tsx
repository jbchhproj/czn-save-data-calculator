  ...
  return (
    <>
      <div className="relative mt-3">
        ...
        {/* main block */}
        <div className="-ml-2 flex h-17 w-[calc(100%+0.5rem)] items-center gap-3 overflow-hidden rounded-r bg-gray-400/20 px-1">
          <div className="-ml-4 flex h-full w-30 shrink-0 flex-col justify-center bg-gray-400/40 pl-5 text-slate-950">
            {labelWordElements}
          </div>
