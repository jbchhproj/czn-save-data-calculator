...
export interface SelectionBlockConfig {
  ...
  stepRule: (current: number, action: "increment" | "decrement", config: SelectionBlockConfig) => number; // Function that determines how the value changes when incrementing or decrementing
